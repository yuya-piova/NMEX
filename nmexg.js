...
NX.GOAL = {
  AprilDivNXT: {
    head: ['Block', 'Unit', 'tenpo', '対面', 'exist2603', 'service2603', 'goal2604'],
    body: [
      ['関東', '東京U', '早稲田', '', '8', '4', '6'],
      ['関東', '東京U', '要町', '', '3', '0', '3'],
      ['関東', '東京U', '豊玉', '', '4', '0', '2'],
      ...
      ['関東', '東京U', '和光', '', '1', '0', '2'],
      ['関東', '東京U', '鶴瀬', '', '0', '0', '2'],
      ['福岡', '福岡中央・西Ｕ', '薬院', '対面', '19', '4', '8'],
      ['福岡', '福岡中央・西Ｕ', '大橋駅前', '', '3', '0', '4'],
      ['福岡', '福岡中央・西Ｕ', '西新修猷館前', '対面', '10', '1', '8'],
      ['福岡', '福岡中央・西Ｕ', '六本松', '', '3', '1', '4'],
      ['福岡', '福岡中央・西Ｕ', '橋本', '対面', '11', '2', '6'],
      ['福岡', '福岡南・東Ｕ', '西鉄久留米', '', '11', '4', '8'],
      ['福岡', '福岡南・東Ｕ', '香椎', '対面', '8', '4', '9'],
      ['福岡', '福岡南・東Ｕ', '東郷', '', '1', '0', '3'],
      ['福岡', '北九州Ｕ', '門司駅前', '', '5', '4', '6'],
      ['福岡', '北九州Ｕ', '下曽根', '', '7', '0', '3'],
      ['福岡', '北九州Ｕ', '折尾駅前', '', '4', '1', '5'],
      ['福岡', '下関Ｕ', '長府駅前', '対面', '9', '5', '8'],
