...
NX.GOAL = {
  AprilDivNXT: {
    head: ['ブロック', 'ユニット', '校舎', '対面', 'exist2603', 'service2603', 'goal2604'],
    body: [
      ['関東', '東京U', '早稲田', '', '8', '4', '6'],
      ['関東', '東京U', '要町', '', '3', '0', '3'],
      ['関東', '東京U', '豊玉', '', '4', '0', '2'],
      ...
      ['関東', '東京U', '和光', '', '1', '0', '2'],
      ['関東', '東京U', '鶴瀬', '', '0', '0', '2'],
      ['福岡', '福岡中央・西Ｕ', '薬院', '対面', '19', '4', '10'],
      ['福岡', '福岡中央・西Ｕ', '大橋駅前', '', '3', '0', '6'],
      ['福岡', '福岡中央・西Ｕ', '西新修猷館前', '対面', '10', '1', '10'],
      ['福岡', '福岡中央・西Ｕ', '六本松', '', '3', '1', '6'],
      ['福岡', '福岡中央・西Ｕ', '橋本', '対面', '11', '2', '8'],
      ['福岡', '福岡南・東Ｕ', '西鉄久留米', '', '11', '4', '10'],
      ['福岡', '福岡南・東Ｕ', '香椎', '対面', '8', '4', '11'],
      ['福岡', '福岡南・東Ｕ', '東郷', '', '1', '0', '5'],
      ['福岡', '北九州Ｕ', '門司駅前', '', '5', '4', '8'],
      ['福岡', '北九州Ｕ', '下曽根', '', '7', '0', '5'],
      ['福岡', '北九州Ｕ', '折尾駅前', '', '4', '1', '7'],
      ['福岡', '下関Ｕ', '長府駅前', '対面', '9', '5', '10'],
      ['福岡', '駿台Diverse', '小倉駅', '対面', '2', '2', '15'],
      ['福岡', '駿台Diverse', '新宮中央', '対面', '5', '5', '13'],
      ['九州', '佐賀Ｕ', '佐賀駅前', '', '12', '5', '15'],
      ['九州', '佐賀Ｕ', '鳥栖', '', '5', '2', '5'],
      ['九州', '長崎Ｕ', '長崎駅前', '対面', '21', '6', '20'],
      ['九州', '長崎Ｕ', '南長崎', '', '7', '1', '5'],
      ['九州', '長崎Ｕ', '葉山', '', '7', '3', '5'],
      ['九州', '熊本Ｕ', '水前寺', '', '4', '0', '5'],
      ['九州', '熊本Ｕ', '健軍', '', '9', '1', '5'],
      ['九州', '熊本Ｕ', '武蔵ケ丘', '', '2', '0', '5'],
      ['九州', '熊本Ｕ', '長嶺', '', '3', '0', '5'],
      ['九州', '大分Ｕ', '大分駅前', '対面', '44', '14', '30'],
      ['九州', '大分Ｕ', '光吉', '', '4', '0', '5'],
      ['九州', '大分Ｕ', '明野', '', '7', '2', '5'],
      ['九州', '宮崎Ｕ', '宮崎駅前', '', '17', '3', '10'],
      ['九州', '宮崎Ｕ', '生目大塚', '', '9', '0', '5'],
      ['九州', '宮崎Ｕ', '花ヶ島', '', '19', '1', '5'],
      ['九州', '鹿児島Ｕ', '鹿児島中央', '対面', '20', '7', '20'],
      ['九州', '鹿児島Ｕ', '東谷山', '', '5', '0', '5'],
      ['九州', '鹿児島Ｕ', '宇宿', '', '2', '0', '5'],
      ['中四国', '広島北Ｕ', '緑井', '', '7', '0', '6'],
      ['中四国', '広島南Ｕ', '広島駅前', '対面', '2', '3', '12'],
      ['中四国', '広島南Ｕ', '古江', '', '6', '2', '9'],
      ['中四国', '広島南Ｕ', '中筋', '', '3', '1', '6'],
      ['中四国', '広島南Ｕ', '皆実町', '', '3', '0', '6'],
      ['中四国', '広島南Ｕ', '安芸府中', '', '8', '0', '7'],
      ['中四国', '岡山北Ｕ', 'HS岡山駅前', '対面', '40', '29', '37'],
      ['中四国', '高松Ｕ', '栗林', '', '8', '3', '8'],
      ['中四国', '高松Ｕ', '木太南', '対面', '17', '4', '11'],
      ['中四国', '高松Ｕ', '水田', '', '1', '0', '6'],
      ['中四国', '高松Ｕ', '番町', '', '6', '4', '8']
    ]
  }
