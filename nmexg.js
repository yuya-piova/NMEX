...
NX.GOAL = {
  AprilDivNXT: {
    ...
    body: [
      ...
      ['関東', '東京U', '和光', '和光', '', '1', '0', '2'],
      ['関東', '東京U', '鶴瀬', '鶴瀬', '', '0', '0', '2'],
      ['福岡', '福岡中央・西Ｕ', '薬院', '薬院', '対面', '19', '4', '10'],
      ['福岡', '福岡中央・西Ｕ', '大橋駅前', '大橋駅前', '', '3', '0', '6'],
      ['福岡', '福岡中央・西Ｕ', '西新修猷館前', '西新修猷館前', '対面', '10', '1', '10'],
      ['福岡', '福岡中央・西Ｕ', '六本松', '六本松', '', '3', '1', '6'],
      ['福岡', '福岡中央・西Ｕ', '橋本', '橋本', '対面', '11', '2', '8'],
      ['福岡', '福岡南・東Ｕ', '西鉄久留米', '西鉄久留米', '', '11', '4', '10'],
      ['福岡', '福岡南・東Ｕ', '香椎', '香椎', '対面', '8', '4', '11'],
      ...
      ['中四国', '広島南Ｕ', '広島駅前', '広島駅前', '対面', '2', '3', '12'],
      ['中四国', '広島南Ｕ', '古江', '古江', '', '6', '2', '9'],
      ['中四国', '広島南Ｕ', '中筋', '中筋', '', '3', '1', '6'],
      ['中四国', '広島南Ｕ', '皆実町', '皆実町', '', '3', '0', '6'],
      ['中四国', '広島南Ｕ', '安芸府中', '安芸府中', '', '8', '0', '7'],
      ['中四国', '岡山北Ｕ', 'HS岡山駅前', 'HS岡山駅前', '対面', '40', '29', '37'],
      ['中四国', '高松Ｕ', '栗林', '栗林', '', '8', '3', '8'],
      ['中四国', '高松Ｕ', '木太南', '木太南', '対面', '17', '4', '11'],
      ['中四国', '高松Ｕ', '水田', '水田', '', '1', '0', '6'],
      ['中四国', '高松Ｕ', '番町', '番町', '', '6', '4', '8'],
      ['中四国', '広島南Ｕ', '白島', '広島駅前', '', '0', '0', '0']
    ]
  }
};
NX.LS = {
