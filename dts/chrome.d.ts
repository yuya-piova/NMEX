...
declare namespace chrome.commands {
  ...
  export interface CommandEvent
    extends chrome.events.Event<(command: string, tab: chrome.tabs.Tab) => void> {}
...
declare namespace chrome.devtools.panels {
  ...
  export interface PanelSearchEvent
    extends chrome.events.Event<(action: string, queryString?: string) => void> {}
...
declare namespace chrome.permissions {
  ...
  export interface PermissionsAddedEvent {
    addListener(
      callback: (/** The newly-acquired permissions*/ permissions: Permissions) => void
    ): void;
  }
...
declare namespace chrome.runtime {
  ...
  export interface ExtensionMessageEvent
    ...
    > {
    removeEventListener(listener: (message: any, sender: any, sendResponse: any) => void): unknown;
  }
...
declare namespace chrome.tabs {
  ...
  export interface TabMovedEvent
    extends chrome.events.Event<(tabId: number, moveInfo: TabMoveInfo) => void> {}
